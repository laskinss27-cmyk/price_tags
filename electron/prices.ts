/**
 * Локальный override-словарь цен по good.id.
 * Лежит в userData/prices.json — переживает обновления приложения.
 *
 * Любая цена тут перекрывает значение из API при печати.
 */
...
export function getPriceOverrides(): PriceMap {
  return load();
}
